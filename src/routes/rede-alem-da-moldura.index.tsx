...
function Rede() {
  ...
  // Retomada automática: quem já tem uma conversa viva no navegador não
  // precisa ver o formulário de novo — vai direto para a tela da conversa.
  useEffect(() => {
    if (lerSessao()) {
...
function Formulario() {
   ...
   * Em seguida abrimos a conversa e navegamos para a tela limpa dela.
   */
  ...
  return (
    <section className="mt-12 rounded-lg border border-border bg-secondary/40 p-6">
      ...
      <p className="mt-2 text-muted-foreground">
        São duas perguntas e, logo depois, uma conversa curta com o Anfitrião — numa tela
        só dela, do seu jeito e no seu tempo.
      </p>
